...
//       entityManager.clear();
    ...
    // 영속상태: 1차 캐시에 등록된 상태
    // 비영속상태: 1차캐시에 등록되지 않은 상태
    // 영속상태인 객체일 경우에만 삭제가 가능하다
    // 삭제 상태: remove()를 사용하여 1차 캐시로부터 삭제된 상태
    //detached 영속상태다  영속상태의 잇엇던 엔터티가 없어짐
