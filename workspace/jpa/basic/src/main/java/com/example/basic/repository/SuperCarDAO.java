...
public class SuperCarDAO {
   ...
   //   전체 조회
    ...
    public void deleteCar() {
        String query = "delete from SuperCar s where s.SuperCarPrice >= 4000";
        entityManager.createQuery(query).executeUpdate();
    }

    public void upPrice(String SuperCarReleaseDate) {
        String query = "update SuperCar s set s.SuperCarPrice = :SuperCarPrice * 1.1 where function('to_char', s.SuperCarReleaseDate, 'yyyymmdd') = :SuperCarReleaseDate";
